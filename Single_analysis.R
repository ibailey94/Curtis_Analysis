...
veg_2021 <- as_tibble(read.csv(
  "/Users/isaacbailey/Curtis/Curtis_Analysis/Final_2021_Curtis_Sample_04062022.csv", header = TRUE))
...
veg_snyder <- as_tibble(read.csv("/Users/isaacbailey/Curtis/Curtis_Analysis/IB_and_MC_Combo_11_10_21 - 2002_Data.csv", header = TRUE))

# Reading in environmental data
cross_walk <- as_tibble(read.csv("/Users/isaacbailey/Curtis/Curtis_Analysis/Snyder_crosswalk.csv", header = TRUE))
...
#### variance_of_species_richness_and_kriging --------------------------------------------------------------------------

# Setting up dataframes
spat_df <- as_tibble(cbind(dmci$veg_2021.Plot, dmci$Easting, dmci$Northing, dmci$NumSpec))
...
# creating site/species matrix for 2002 data
...
colnames(addon_dmci) <- unique(ni_dmci)
...
colnames(addon_snyder) <- unique(ni_snyder)
...
### Phylogenetic_Distance_Calculations ---------------------------------------------------------------------------------
